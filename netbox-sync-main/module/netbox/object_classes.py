...
class NBNamespace(NetBoxObject):
    name = "namespace"
    api_path = "plugins/custom-objects/namespaces"  # Adjust based on plugin config
    object_type = "plugins.custom_objects.namespace"  # Adjust based on plugin
    primary_key = "name"
    prune = True
...
class NBBucket(NetBoxObject):
    name = "bucket"
    api_path = "plugins/custom-objects/buckets"  # Adjust based on plugin config
    object_type = "plugins.custom_objects.bucket"  # Adjust based on plugin
    primary_key = "name"
    secondary_key = "namespace"
    prune = True

    def __init__(self, *args, **kwargs):
        self.data_model = {
            "name": 100,
            "namespace": NBNamespace,
            "size": int,
            "description": 200,
            "tags": NBTagList,
            "custom_fields": NBCustomField
...
class NBUser(NetBoxObject):
    name = "user"
    api_path = "plugins/custom-objects/users"  # Adjust based on plugin config
    object_type = "plugins.custom_objects.user"  # Adjust based on plugin
